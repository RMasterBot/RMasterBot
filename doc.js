...
Doc.prototype.showHelp = function() {
  ...
  console.log("\n" + 'Usage:');
  console.log("    " + 'doc <application>                                 list all endpoints');
  console.log("    " + 'doc <application> <http_method>                   list all endpoints using given method');
  console.log("    " + 'doc <application> <endpoint_url>                  endpoint detail');
  console.log("    " + 'doc <application> <http_method> <endpoint_url>    endpoint detail using given method');
  console.log("    " + 'doc <application> parameters                      list all parameters');
